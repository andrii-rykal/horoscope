  ...
  const metrics = [
    {
      ...
      value: forecast.love,
      type: 'love',
      icon: <Heart className={clsx(styles.metricIcon, styles.love)} size={18} />,
      color: 'rgb(244, 63, 94)',
    },
    {
      label: 'Health',
      ...
      type: 'health',
      icon: <Brain className={clsx(styles.metricIcon, styles.health)} size={18} />,
    ...
    },
    {
      ...
      type: 'career',
      icon: <Briefcase className={clsx(styles.metricIcon, styles.career)} size={18} />,
      color: 'rgb(34, 197, 94)',
    },
  ];
